...
<div class="flex justify-center px-8">
    <div class="xl:w-[80vw]">
        <a href="/vacancies" data-astro-reload class="w-fit items-center text-[#1e1e1e] text-2xl lg:text-4xl font-bold text-pretty mb-6 flex flex-row gap-2 hover:animate-pulse group">latest posts
