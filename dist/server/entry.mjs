...
import { manifest } from './manifest_DBBQz8vT.mjs';
...
const _page5 = () => import('./pages/headofeducation.astro.mjs');
const _page6 = () => import('./pages/iod.astro.mjs');
const _page7 = () => import('./pages/recruitment-incentives.astro.mjs');
const _page8 = () => import('./pages/resources.astro.mjs');
const _page9 = () => import('./pages/vacancies.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/headofeducation.astro", _page5],
    ["src/pages/iod.astro", _page6],
    ["src/pages/recruitment-incentives.astro", _page7],
    ["src/pages/resources.astro", _page8],
    ["src/pages/vacancies.astro", _page9],
